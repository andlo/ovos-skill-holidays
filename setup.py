...
URL = "https://github.com/andlo/ovos-skill-holidays"
SKILL_CLAZZ = "Holidays"
PYPI_NAME = "ovos-skill-holidays"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Public holidays, Easter, and calendar-date math for OVOS, fully offline",
    ...
    keywords="ovos skill voice assistant holidays calendar easter date",
